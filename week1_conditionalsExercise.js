...
function exercise1(num1) {
  ...
  console.log(exercise2(10));
  console.log(exercise2(25));
  ...
  console.log(exercise3(3));
  console.log(exercise3(-5));
  ...
  function exercise4(varA, varB) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
        if ((varA === varB) && (varA = Number || '') && (varB = Number || '')) {
  ...
  console.log(exercise4(5,'5'));
  console.log(exercise4('Hello World', 'Hello World'));
  console.log(exercise4('Hello', 'World'));
  ...
  // If there is value conversion then a number and a string may seem like they are equal equal. This would be the difference between == and ===.
  ...
  console.log(exercise6(7,7,8));
  console.log(exercise6(5,5,5));
  console.log(exercise6('hello', 'hello', 'hello'));
  ...
  console.log(exercise8(3,4,1,6));
  console.log(exercise8(50,51,1,100));
  console.log(exercise8(1,8,5,10));
  console.log(exercise8(5,15,2,10));
  console.log(exercise8(7,8,9,10));
  ...
  console.log(exercise10(8));

  
  // Congrats, you made it to the end! You rock!
  // Did you find this easy or hard? If you used references, which ones helped you?
  // Please answer in a comment below.
  //I found this mostly easy but I did have a bit of a challenge with questions number 7 and 9.
  //The resources I used were the MDN and W3 schools for the two questions I found challenging.
